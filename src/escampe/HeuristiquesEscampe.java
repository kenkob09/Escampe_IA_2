...
public class HeuristiquesEscampe {
	...
	//Heuristique qui fait la somme des distances des pions amis de la licorne ami
	...
	//Heuristique qui renvoie +infini si c'est gagne pour ami, -infini si c'est perdu pour ami
